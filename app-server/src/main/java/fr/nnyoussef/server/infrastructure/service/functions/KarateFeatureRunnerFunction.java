...
public final class KarateFeatureRunnerFunction
    ...
    public Flux<ServerSentEvent<String>> apply(FeatureRunnerRequestBody featureRunnerRequestBody) {
        return Flux.create(sink -> {
            ...
            String featurePath = Path.of(getResDir(), featureRunnerRequestBody.path()).toString();
            String uuid = sink.contextView().get(ID);

            TestContext.getInstance().putTestParamsByUuid(uuid, testParams);
            ...
            Runner.builder()
                    ...
                    .hook(new TestRunnerEventListener(sink, uuid))
                    .configDir("")
                    .reportDir(null)
                    .buildDir(null)
    ...
    private final class TestRunnerEventListener implements RuntimeHook {
        ...
        public void afterSuite(Suite suite) {
            sink.complete();
            TestContext.getInstance().removeTestParamsByUuid(uuid);
        }
